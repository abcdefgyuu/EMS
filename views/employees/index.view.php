...
<main>
  <div class="bg-neutral-100 pt-24 min-h-screen">
    <div class="inner">
      ...
      <input type="text" id="search" class="w-64 md:w-1/3 mb-3 md:mb-8 mx-auto block px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none" placeholder="Search by name or email..." />
      <div class="mb-4 md:flex justify-between items-center">
        <div class="w-full md:w-2/3">
          ...
          <select id="roleFilter" class="w-28 md:w-1/4 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none">
          ...
          <?php foreach ($employees as $employee) : ?>
            <tr>
              ...
              <td class="flex items-center justify-center">
                <a href="#" class="btn btn-edit mr-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                  </svg>
                </a>
                <form action="" method="POST" class="inline-block">
                  <input type="hidden" name="_method" value="DELETE">
                  <button class="btn btn-delete"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<!--<script>
  ...
  for (let i = 1; i <= 53; i++) {
    employees.push({
      ...
      role: ["Manager", "Developer", "Analyst", "Executive"][i % 4],
  ...
  function renderPagination(totalRows) {
    ...
    if (startPage > 1) {
      addPageButton(1);
      if (startPage > 2) {
        $("<button>").text("...").appendTo($pagination);
      }
    }
